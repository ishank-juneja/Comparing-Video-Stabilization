...
# # Avg method has 2 fewer frames in the output than it has in the input
# # Subspace: The last 40 frames present in the original are absent from the subspace stab result
#
